  ...
  return (
    <section className="relative w-full overflow-hidden h-screen bg-black" style={{ height: '100dvh' }}>
      ...
      <div className="z-30 absolute inset-0">
        <RevealLayer baseRevealImage={BG_IMAGE_2} cursorX={x} cursorY={y} radius={SPOTLIGHT_R} />
      </div>

      {/* 主标题 */}
      <div className="absolute top-[14%] left-0 right-0 flex flex-col items-center text-center px-5 pointer-events-none z-50">
        <span
          className="block font-playfair italic font-normal text-5xl sm:text-7xl md:text-8xl hero-anim hero-reveal text-white leading-[0.95]"
          style={{ letterSpacing: '-0.05em', animationDelay: '0.25s' }}
        >
          Layers hold
        </span>
        <span
          className="block font-normal text-5xl sm:text-7xl md:text-8xl -mt-1 hero-anim hero-reveal text-white leading-[0.95]"
